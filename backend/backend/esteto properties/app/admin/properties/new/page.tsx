...
export default function NewPropertyPage() {
  ...
  const fetchFormData = async () => {
    ...
    try {
      const [catRes, amenRes, cityRes] = await Promise.all([
    ...
    <form onSubmit={handleSubmit} className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" value={formData.title} onChange={(e) => setFormData(prev => ({ ...prev, title: e.target.value }))}
                  ...
                  placeholder="e.g., Luxury 3BHK Apartment in Gomti Nagar" />
              </div>
              <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="text" value={formData.location} onChange={(e) => setFormData(prev => ({ ...prev, location: e.target.value }))}
                  className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                  placeholder="e.g., Plot 12, Sector 5, Gomti Nagar" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
          ...
          {/* Images */}
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <h2 className="font-semibold text-gray-900 mb-4 flex items-center gap-2"><ImageIcon className="w-5 h-5" />Images</h2>
            <div className="space-y-4">
              ...
              <p className="text-xs text-gray-500">First image will be used as cover. Max 10 images recommended.</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="flex flex-wrap gap-2">
              {(amenitiesList.length > 0 ? amenitiesList.map(a => a.name) : [
                ...
                const name = typeof amenity === 'string' ? amenity : amenity
                return (
